...
#define AUDIO_TASK_STACK_SIZE 8096
...
int main()
{
    ...
    if(CY_RSLT_SUCCESS != cy_retarget_io_init(CYBSP_DEBUG_UART_TX, CYBSP_DEBUG_UART_RX, CY_RETARGET_IO_BAUDRATE))
    {
        while(1);
    }
    ...
    printf("\x1b[2J\x1b[;H");
    printf("===============================================================\n");
    printf("MQTT Client w/ SensiML audio recognition \n");
    printf("===============================================================\n\n");

    /* Initialize audio recording ... */
    printf("Initializinge audio recording ...\n\n");
    result = audio_init();
    ...
    xTaskCreate(audio_task, "audiotask", AUDIO_TASK_STACK_SIZE, NULL, AUDIO_TASK_PRIORITY, NULL);
